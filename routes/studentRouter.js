...
router.put('/pre-school/archive/:id', isAdmin, studentController.preSchool.archive)
...
router.put('/fitzroy/archive/:id', isAdmin, studentController.fitzroy.archive)
...
router.put('/post-fitzroy/archive/:id', isAdmin, studentController.postFitzroy.archive)
